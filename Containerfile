...
RUN mkdir -p /usr/share/backgrounds && \
    ...
    "https://raw.githubusercontent.com/a-person-27/flux-linux/main/ledora-wallpaper.png" \
    && ostree container commit

RUN mkdir -p /usr/share/pixmaps && \
    curl -L -o /usr/share/pixmaps/ledora-logo.png \
    "https://raw.githubusercontent.com/a-person-27/flux-linux/main/ledora-logo.png" \
    && ostree container commit
...
RUN flatpak install --system --noninteractive flathub com.valvesoftware.Steam \
    && ostree container commit
